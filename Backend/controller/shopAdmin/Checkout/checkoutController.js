...
//   // Generate one group ID for all products in this order
//   const orderGroupId = uuidv4();

//   // Recursive insert for each product
//   const insertNext = (index) => {
//     if (index >= products.length) {
//       return res.status(201).json({
//         success: true,
//         orderGroupId, // return group ID
//       });
//     }
...
//       "pending",       // status
//       "NOT PAID"       // payment_status (since no online payment)
//     ];
...
//       insertNext(index + 1); // insert next product
//     });
//   };
...
// // group id for receipt today 28-02-2026
...
//     // ✅ Separate order details + products
//     const orderDetails = {
//         id: rows[0].id,
...
//         delivery_date: row.delivery_date,   // ADD THIS
//     return_date: row.return_date,
//     deposit_amount: row.deposit_amount // added for deposit 
//       }))
//     };
...
// comment for inventory report make dynamic for stock today is : 05-03-2026
