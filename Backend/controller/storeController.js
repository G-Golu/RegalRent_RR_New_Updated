...
// all ok everything correct , comment for only , add auto remainder email 26-03-2026
...
//     sendEmail(
//       store.email,
//       "Package Expiry Reminder ⚠️",
//       `<p>Dear ${store.name},</p>
//        <p>Your package will expire in <b>${diffDays} day(s)</b>. 
//        Please renew it to continue enjoying our services.</p>`
...
//       "Package Expired ",
//       `<p>Dear ${store.name},</p>
//        <p>Your package has expired today. Please contact the admin through the contact form to renew.</p>`
//     ).catch(err => console.error("Mail error:", err));
...
//   // Today 26-03-2026 , added new SEND REMAINDER EMAIL TO STORE USER =================================================================
//  successfully working , now comment for specific message send and updated value send user
