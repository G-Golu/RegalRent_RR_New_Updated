...
console.log("Stored Token:", localStorage.getItem("token"));
  ...
  return (
    <div className="glassy-login-page">
 ...
 {/*  GLOW ORBS */}
  ...
  <span className="orb orb5"></span>
  <span className="orb orb6"></span>
  <span className="orb orb7"></span>

      <div className="glassy-login-card">
         {/* LEFT SIDE */}
    <div className="glassy-left">
      <img src="/authImg/illustraction.png" alt="login visual" />
    </div>

    {/* RIGHT SIDE */}
    <div className="glassy-right">
      <h2>Welcome Back 👋</h2>

        <form onSubmit={handleLogin} className="glassy-form">
